...
import 'package:norq_machine_test/ui/pages/product_details/product_details.dart';
import 'package:norq_machine_test/utils/extensions/margin_ext.dart';
import 'package:norq_machine_test/utils/shared/page_navigator.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppAppbar(
          ...
          actions: [
            GestureDetector(
                onTap: () => Screen.open(context, CartPage()),
                child: Icon(
                  Icons.trolley,
                  size: 30,
                )),
                                  ...
                                  GridView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return GestureDetector(
                                        onTap:() =>  Screen.open(context, ProductDetails(data: data)),
                                        child: Card(
                                          elevation: 5,
